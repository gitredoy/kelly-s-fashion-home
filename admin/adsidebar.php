          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item" id="collap">
              <a class="nav-link arrow" href="#" data-toggle="collapse" data-target="#e-commerce" class="collapsed active"><span class="icon"><i class="fa fa-shopping-cart" aria-hidden="true"></i></span> <span class="nav-label">All Products</span></a>
